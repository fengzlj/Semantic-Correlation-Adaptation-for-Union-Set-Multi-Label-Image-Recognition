...
class KLLoss(nn.Module):
    ...
    def forward(self, input1, input2, target, forget_rate):
        loss_pick_1 = self.bce_loss(input1, target) 
        loss_pick = ((loss_pick_1) * (1-self.co_lambda) + self.co_lambda * self.kl_loss(input1, input2) + self.co_lambda * self.kl_loss(input2, input1)).cpu() 
